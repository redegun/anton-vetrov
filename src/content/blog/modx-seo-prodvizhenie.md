...
- **[Относительные ссылки в MODX: как одна настройка создаёт сотни 404](/blog/modx-otnositelnye-ssylki-404/)** — частая ошибка с `link_tag_scheme`, которая ломает навигацию
