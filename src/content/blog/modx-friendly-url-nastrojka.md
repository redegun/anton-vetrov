...
**Читайте также:** [Относительные ссылки в MODX: как одна настройка создаёт сотни 404](/blog/modx-otnositelnye-ssylki-404/) — разбираю, почему `link_tag_scheme = -1` ломает навигацию на вложенных страницах.
